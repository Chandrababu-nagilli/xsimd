 ...
 * @ingroup xsimd_config_macro
 *
 * Set to 1 if IBM Z Vector (zvector) is available at compile-time.
 * Requires -mzvector and __VEC__ to be defined by the compiler.
 */
#if defined(__VEC__) && defined(__s390x__)
#define XSIMD_WITH_ZVECTOR 1
#else
#define XSIMD_WITH_ZVECTOR 0
#endif
